  ...
  return (
    ...
    <div className=' mx-auto mt-16 inter-500'>
        <section className='mx-4 flex flex-col' >
            ...
            <p className='flex items-end gap-1 text-sm'><Image src='/icons/phone.svg' width={19} height={20} alt='hola' ></Image><a href="tel:+34600000000" className="text-black/80 inter-300 text-start">+34 600 000 000</a></p>
        </section>
            <section className='h-72 mt-4'>
