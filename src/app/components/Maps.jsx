...
function Maps() {
  return (
    ...
    <div className='mx-auto mt-16 inter-500'>
        <section className='mx-5 mb-5 flex flex-col' >
            ...
            <p className='flex items-end gap-1 text-sm'><Image src='/icons/phone.svg' width={16} height={20} alt='hola' ></Image><a href="tel:+34600000000" className="text-black/80 inter-300 text-start">+34 600 000 000</a></p>
        </section>
        <aside className='bg-black/90 text-white text-[10px] py-2 text-center inter-400'>
